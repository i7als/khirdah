...
export function TrendingUpIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5L9.5 10l4 4L21 6.5" />
...
export function TrendingDownIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 7.5L9.5 14l4-4L21 17.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.5 17.5H21V12" />
    </svg>
  );
}
...
export function ScaleIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6L5 8l3.2 6.2a3.6 3.6 0 003.6 0L15 8l-3-2z" />
    </svg>
  );
}
...
export function WalletIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M17 14.25h1.5" />
    </svg>
  );
}
...
export function BuildingIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 7.5h1.5M13.5 7.5H15M9 11h1.5M13.5 11H15M9 14.5h1.5M13.5 14.5H15" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10 20.5v-4h4v4" />
    </svg>
  );
}
